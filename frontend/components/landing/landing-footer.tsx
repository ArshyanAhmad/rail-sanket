    ...
    <footer className="border-t border-slate-200 bg-white text-slate-600">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
          ...
          <div className="space-y-4 md:col-span-6">
            ...
            <div className="inline-flex items-center gap-1.5 rounded border border-slate-200 bg-slate-50 px-2.5 py-1 text-xs font-medium text-slate-700">
              ...
              <span>Smart India Hackathon 2026 &middot; Problem Statement SIH26027</span>
            </div>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <div>
            &copy; {new Date().getFullYear()} Rail Sanket &middot; SIH 2026 Prototype
          </div>
          <div className="text-[11px] text-slate-400 text-center sm:text-right max-w-lg">
            Decision-support prototype demonstrated for Smart India Hackathon.
            Not an official operational deployment or portal of Indian Railways or Ministry of Railways.
          </div>
        </div>
