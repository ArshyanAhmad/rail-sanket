    ...
    <section id="home" className="relative overflow-hidden min-h-[560px] lg:min-h-[620px] flex items-center pt-10 pb-14 sm:pt-14 sm:pb-18 lg:pt-16 lg:pb-20">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-xl lg:max-w-2xl space-y-5">
          ...
          {/* Refined Pill Badge */}
          <div className="inline-flex items-center gap-2 rounded-full border border-sky-400/30 bg-slate-950/70 px-3.5 py-1 text-[11px] font-semibold text-sky-200 shadow-sm backdrop-blur-md">
          ...
          <div className="pt-4 border-t border-white/15 flex flex-wrap items-center gap-2.5 text-[11px] font-medium text-slate-200">
