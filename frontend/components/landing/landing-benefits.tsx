            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[10px] font-mono font-bold text-primary bg-blue-50/60 border border-blue-100 rounded px-2 py-0.5">
                    {b.stat}
                  </span>
                </div>
              ...
              <div className="mt-6 pt-3 border-t border-slate-200/60 flex items-center justify-between">
                ...
                <span className="text-[11px] font-semibold text-slate-500">Divisional Benefit</span>
              </div>
            </div>
          ))}
        </div>
