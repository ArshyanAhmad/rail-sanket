      ...
      <div className="rounded-lg border border-border bg-white p-3 shadow-xs">
        <div className="flex items-center justify-between gap-2 overflow-x-auto text-xs">
          ...
          <div className="flex items-center gap-2 font-medium text-slate-700">
            <span className="flex size-5 items-center justify-center rounded-full bg-slate-200 text-[11px] font-bold text-slate-700">
              2
            </span>
          ...
          <Card className={cn(
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="inline-flex items-center gap-1 rounded-full bg-blue-100 px-2.5 py-0.5 text-[11px] font-bold text-blue-700 border border-blue-200">
                ...
                <div className="flex items-center gap-2">
                  <div className="text-right sm:block hidden">
                    <span className="text-[10px] uppercase font-bold text-slate-400 block">Corridor</span>
            ...
            <CardContent className="p-4 sm:p-5 space-y-5">
                  ...
                  {tasks.map((task) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <span className="rounded bg-white px-2 py-0.5 text-[10px] font-semibold border border-slate-200 text-slate-600">
                          {task.dept}
                        </span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 p-3 rounded-lg border border-slate-200 bg-slate-50/70 text-xs">
                ...
                <div>
                  <span className="text-slate-500 block text-[11px]">Window Capacity</span>
                  <span className="font-mono font-bold text-sm text-slate-900">120 min (2.0h)</span>
                </div>
                <div>
                  <span className="text-slate-500 block text-[11px]">Utilization</span>
          ...
          <div className="space-y-4">
            <Card className={cn(
              ...
              <CardContent className="space-y-3 text-xs text-slate-600">
                ...
                <div className="rounded border border-slate-200 bg-slate-50 p-2.5 text-[11px] space-y-1">
